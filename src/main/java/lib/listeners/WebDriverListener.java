...
public class WebDriverListener extends Reports  implements WebDriverEventListener {
	...
	public void afterNavigateTo(String url, WebDriver driver) {
		String desc="The browser loaded the URL"+url; 
		System.out.println(desc);
		//this.reportSteps(desc, "pass");
		takeSnap();
	}
	...
	public void afterNavigateBack(WebDriver driver) {
		System.out.println("The browser has loaded the previous page from the history "+driver.getTitle());
		takeSnap();
	}
	...
	public void afterNavigateForward(WebDriver driver) {
		System.out.println("The browser has loaded the next page "+driver.getTitle());
		takeSnap();
	}
	...
	public void afterChangeValueOf(WebElement element, WebDriver driver, CharSequence[] keysToSend) {
		try {
			System.out.println("The value "+keysToSend[0]+" is entered successfully in element "+element.getTagName());
		} catch (Exception e) {
